...
\nomenclature{$\nabla f(\theta~;~\textbf{x})$}{Gradient of $f$ with respect to parametrization $\theta$ and input $\textbf{x}$.}
...
\nomenclature{$\mathcal{L}(\theta~;~\textbf{x})$}{Loss function with respect to parametrization $\theta$ and input $\textbf{x}$.}

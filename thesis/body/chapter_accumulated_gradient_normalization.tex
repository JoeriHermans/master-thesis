...
\begin{equation}
  ...
  \lim_{\lambda \to \infty} - \frac{\vec{c}}{\lambda}
\end{equation}

Since $\vec{c}$ is finite, Equation~\ref{eq:agn_thought_experiment_2} can be treated as an instance of $\frac{1}{\infty}$, which approaches 0. Subsequently, Equation~\ref{eq:agn_thought_experiment_2} is 0 in the limit to infinity, as summarized in Equation~\ref{eq:agn_thought_experiment_3}.

\begin{equation}
  \label{eq:agn_thought_experiment_3}
